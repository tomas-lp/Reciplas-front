        ...
        <div className="flex flex-col w-full md:w-auto md:flex-row items-center mb-5 md:mb-0">
          <div className="flex flex-col sm:flex-row w-full md:w-auto justify-center items-center sm:h-10 px-4 lg:px-5 bg-verylight rounded-xl font-title font-normal text-base">
            <div className="flex flex-row items-start">
              ...
              <input
                type="text"
                className="mb-2 sm:mb-0 sm:mr-8 bg-verylight text-center text-black font-title text-base font-normal outline-none w-24 border-b-2 border-verylight focus:border-b-2 focus:border-primary transition-all"
                placeholder="Ejemplo"
              />
            </div>
            <div className="flex flex-row items-start">
              ...
              <input
                type="text"
                className=" bg-verylight text-center text-black font-title text-base font-normal outline-none w-24 border-b-2 border-verylight focus:border-b-2 focus:border-primary transition-all"
                placeholder="Ejemplo"
              />
            </div>
          </div>
