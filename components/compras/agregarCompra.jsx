          ...
          <div className="flex flex-row items-center">
            <div className="flex justify-center items-center h-10 px-5 bg-verylight rounded-xl font-title font-normal text-base">
              <div className="flex flex-row items-start">
                ...
                <input type="text" className="mr-8 bg-verylight text-center text-black font-title text-base font-normal outline-none w-24 border-b-2 border-verylight focus:border-b-2 focus:border-primary transition-all" placeholder="Ejemplo"/>
              </div>
              <div className="flex flex-row items-start">
                <span className="mr-2">Recepcionista:</span>
