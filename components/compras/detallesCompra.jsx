    ...
    <div className="flex flex-col w-full max-w-screen-xl">
        <div className="flex flex-col md:flex-row justify-between items-center mb-5 md:h-12">
          <div className="flex flex-col w-full md:w-auto md:flex-row items-center mb-5 md:mb-0">
            <div className="flex w-full md:w-auto mb-2 md:mb-0 md:mr-5 justify-center items-center h-10 px-4 lg:px-5 bg-medium text-white rounded-xl font-title font-normal text-base"><span>Recepcionista: Nombre</span></div>
