    ...
    <div className="flex flex-col w-full max-w-screen-xl">
        <div className="flex flex-row justify-between items-center mb-5 h-12">
          <div className="flex flex-row items-center">
            <div className="flex justify-center items-center h-10 px-5 bg-medium text-white rounded-xl mr-5 font-title font-normal text-base"><span>Recepcionista: Nombre</span></div>
            <div className="flex justify-center items-center h-10 px-5 bg-verylight rounded-xl font-title font-normal text-base">
              <span className="mr-8">Proveedor: 0000</span>
          ...
          <div className="bg-verylight flex flex-col items-center p-12 rounded-3xl">
            ...
            <div className="bg-verylight flex flex-col rounded-3xl w-full">
              ...
              <div className="flex flex-row justify-end mt-5">
                <span className="flex justify-center items-center h-10 px-5 bg-darkgrey text-white rounded-xl font-title font-normal text-base ml-5">Cantidad total: 0000</span>
                <span className="flex justify-center items-center h-10 px-5 bg-darkgrey text-white rounded-xl font-title font-normal text-base ml-5">Importe total: $0000</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-row mt-5">
          <div className="flex justify-center items-center h-10 px-5 mr-5 bg-primary rounded-xl cursor-pointer hover:bg-primarydark transition-all">
            <img src="/Icons/White/registrarpago.png" alt="" className="h-5 mr-2"/>
            <span className="text-white font-title font-normal text-lg">Registrar Pago</span>
          </div>
        </div>
    </div>
  )
