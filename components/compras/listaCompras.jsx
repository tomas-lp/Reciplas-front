  ...
  return(
    <>
      <div className="flex flex-col w-full max-w-screen-xl">
        ...
        <div className="bg-verylight flex flex-col px-4 py-8 sm:p-8 rounded-3xl">
          <div className="flex flex-col-reverse lg:flex-row justify-between">
            <div className="flex flex-row w-full justify-between items-end h-12">
              <div className="flex flex-row items-end h-12">
                ...
                <div className="bg-light w-24 p-2 rounded-t-xl flex justify-center mx-2 h-8 hover:h-10 transition-all cursor-pointer"><span className="text-title text-sm text-grey">Proveedor</span></div>
                <div className="bg-light w-24 p-2 rounded-t-xl hidden md:flex justify-center mx-2 h-8 hover:h-10 transition-all cursor-pointer"><span className="text-title text-sm text-grey">Total en kg</span></div>
                <div className="bg-light w-24 p-2 rounded-t-xl hidden sm:flex justify-center mx-2 h-8 hover:h-10 transition-all cursor-pointer"><span className="text-title text-sm text-grey">Total en $</span></div>
              </div>
