    ...
    <div className="flex flex-col w-full max-w-screen-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="bg-verylight flex flex-col items-center p-4 py-12 sm:p-12 rounded-3xl">
            <h2 className="text-black font-title font-light text-2xl mb-5">Historial de ventas</h2>
              ...
              <div className="flex flex-row justify-between">
                <div className="flex flex-row items-end h-12 justify-between w-full">
                  <div className="flex flex-row items-end h-12">
                    ...
                    <div className="bg-light w-24 p-2 rounded-t-xl hidden sm:flex justify-center mx-2 h-8 hover:h-10 transition-all cursor-pointer"><span className="text-title text-sm text-grey">Fecha</span></div>
                  </div>
