    ...
    <>
      <div className="flex flex-col w-full max-w-screen-xl">
        ...
        <div className="flex flex-row items-center mb-5 ml-2">
          ...
          <span className="font-title text-black font-normal text-md">
          ...
          <div className="flex flex-col-reverse lg:flex-row justify-between">
            <div className="flex flex-row w-full justify-between items-end h-12">
              <div className="flex flex-row items-end h-12">
                ...
                <div className="hidden bg-light w-24 p-2 rounded-t-xl sm:flex justify-center mx-2 h-8 hover:h-10 transition-all cursor-pointer">
