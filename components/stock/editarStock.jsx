    ...
    <div className="flex flex-col w-full max-w-screen-xl">
      <div className="flex flex-row justify-between items-center mb-5 h-12">
        <div className="flex flex-row items-center">
          ...
          <div className="flex justify-center items-center h-10 px-5 bg-verylight rounded-xl mr-5 font-title font-normal text-base"><span>Tipo: Productos producidos</span></div>
      ...
      <div className="grid grid-cols-2 gap-5 mb-8">
        <div className="bg-verylight flex flex-col items-center p-12 rounded-3xl">
          ...
          <div className="flex flex-col max-w-xl w-full rounded-xl p-3">
            ...
            <input type="text" size="14" className="bg-verylight text-black font-title text-lg font-normal outline-none h-10 w-48 border-b-2 border-verylight focus:border-b-2 focus:border-primary hover:border-b-2 hover:border-primary transition-all" defaultValue="Ejemplo" placeholder="Ejemplo"/>
          </div>
          <div className="flex flex-col max-w-xl w-full rounded-xl p-3">
            <span className="text-black font-title text-lg font-medium">Descripción:</span>
            <textarea name="" id="" rows="3" className="resize-none appearance-none bg-verylight text-black font-title text-lg font-normal outline-none h-24 w-64 border-b-2 border-verylight focus:border-b-2 focus:border-primary hover:border-b-2 hover:border-primary transition-all" defaultValue="Ejemplo" placeholder="Ejemplo"></textarea>
          </div>
        </div>
        <div className="bg-verylight flex flex-col items-center p-12 rounded-3xl">
          ...
          <div className="flex flex-col max-w-xl w-full rounded-xl p-3">
            ...
            <input type="text" size="14" className="bg-verylight text-black font-title text-lg font-normal outline-none h-10 w-48 border-b-2 border-verylight focus:border-b-2 focus:border-primary transition-all hover:border-b-2 hover:border-primary" defaultValue="0000" placeholder="0000"/>
          </div>
          <div className="flex flex-col max-w-xl w-full rounded-xl p-3">
            <span className="text-black font-title text-lg font-medium">Cantidad mínima:</span>
            <div className="flex flex-row items-center">
              <input size="12" type="text" className="bg-verylight text-black font-title text-lg font-normal outline-none h-10 border-b-2 border-verylight focus:border-b-2 focus:border-primary transition-all hover:border-b-2 hover:border-primary" defaultValue="0000" placeholder="0000"/>
            </div>
          </div>
          <div className="flex flex-col max-w-xl w-full rounded-xl p-3">
